...
const plugins = [
  ...
  new HtmlWebpackPlugin({
    ...
    template: 'app/templates/index.dev.html'
  }),
...
function dependencyHandlers () {
  ...
  if (!dllPlugin) {
    logger.warn('The DLL config is missing, we use DLL to accelarate your web.')
    return []
    // return [
  ...
  const dllManifests = Object.keys(dllPlugin.dlls).map((name) => path.join(dllPath, `/${name}_manifest.json`))
  ...
  return dllManifests.map((manifestPath) => {
    ...
    console.log(`${manifestPath} dll added to reference olugin`)
